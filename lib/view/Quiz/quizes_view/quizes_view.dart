import 'package:eng_learning_app/view/Quiz/quizes_view/quizes_viewModel.dart';
import 'package:eng_learning_app/view/Quiz/quizes_view/widget/card.dart';
...
class QuizesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        viewModelBuilder: () => QuizesViewmodel(),
        builder: (context, QuizesViewmodel viewModel, child) {
          return Scaffold(
